...
class AsyncTracker {
 public:
  ...
  static int64_t GetTargetResourceTypeStart() {
    return ResourceTypeToIndex(ResourceType::kTargetResourceTypeStart);
  }

  // Returns the number of target defined resources
  virtual int64_t GetNumTargetResources() const;
